...
.claude/project-oracles/cors-allowlist-enforcement/oracle.sh

# Full loop (adds Probe C integration smoke):
.claude/project-oracles/cors-allowlist-enforcement/oracle.sh --full

# Windows (PowerShell):
.claude\project-oracles\cors-allowlist-enforcement\oracle.ps1

# Direct Python (cross-platform):
python .claude/project-oracles/cors-allowlist-enforcement/oracle.py [--full]
```
