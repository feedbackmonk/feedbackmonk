...
| 2. AST / artifact oracle (this file) | Probe A (yaml-lint) + Probe B (env-doc-xref against C21) + Probe C (`--full` clean-state smoke) | `.claude/project-oracles/selfhost-compose-smoke/` |
