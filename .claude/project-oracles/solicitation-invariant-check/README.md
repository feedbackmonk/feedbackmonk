...
python .claude/project-oracles/solicitation-invariant-check/oracle.py
bash   .claude/project-oracles/solicitation-invariant-check/oracle.sh      # Unix shim
pwsh   .claude/project-oracles/solicitation-invariant-check/oracle.ps1     # Windows shim

# With Probe C (behavioral drift-detection — requires DB + cargo):
python .claude/project-oracles/solicitation-invariant-check/oracle.py --full
```
