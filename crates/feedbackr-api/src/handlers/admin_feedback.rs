...
use feedbackr_core::{legal_transitions_from, FeedbackId, FeedbackKind, FeedbackStatus};
use feedbackr_repository::{ProjectScope, ReplyVisibility, TenantScope};
...
pub(crate) async fn perform_transition(
    ...
    let audit_id = state
        ...
        .await
        .map_err(|e| match e {
            feedbackr_repository::RepoError::NotFound => ApiError::Conflict(json_err(
