//! Prod SMTP mailer -- credentials and host from `FEEDBACKR_SMTP_*` env vars.
//!
//! Env vars consumed at startup (`main.rs::build_state`):
//!   - `FEEDBACKR_SMTP_HOST`
//!   - `FEEDBACKR_SMTP_PORT` (default 587)
//!   - `FEEDBACKR_SMTP_USER`
//!   - `FEEDBACKR_SMTP_PASS`
//!   - `FEEDBACKR_SMTP_FROM` -- the visible From address
//!   - `FEEDBACKR_SMTP_STARTTLS` (`true`/`false`, default `true`)
